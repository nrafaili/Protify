...
from base_models.get_base_models import get_base_model_for_training, get_tokenizer
        ...
        def train():
            ...
            try:
                ...
                if self.trainer_args.full_finetuning:
                    # Create model for full finetuning
                    ...
                    # Create model and probe for hybrid training
                    tokenwise = self.probe_args.tokenwise
                    num_labels = self.probe_args.num_labels
                    ...
                    model, _, test_metrics = self.trainer_hybrid_model(
                        model=model,
                        tokenizer=tokenizer,
                        probe=probe,
                        model_name=model_name,
                    ...
                    # Create probe for regular probe training
                    probe = get_probe(self.probe_args)
