...
from transformers.models.t5.modeling_t5 import T5Attention as TransformerT5Attention
...
class T5Attention(TransformerT5Attention):
    def __init__(
        self,
        config: T5Config,
    ...
    def forward(
        ...
        """
        TODO
        Flex attention takes over here
        """
